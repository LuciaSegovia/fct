...
### Food name conventions

- Cereals: We have excluded the word "dried" for referring to cooked from dried cereals from the names (for example "rice grain, parboiled, local, **dried**, boiled") because cereals, are almost always dried by nature. So, there are almost no cases of cereal being consumed "fresh". This is not the case for legumes and pulses that can be both find fresh (from the pod) or dried (to extend the shelf live). See "pulses" for more information. 

- Pulses: We are adding to the name of the cooked foods whether was cooked from dried (e.g., "broad bean, **dried**, not soaked, boiled, drained). If it was cooked from the fresh pod it will be also especified (e.g., "broad bean, **fresh**, not soaked, boiled, drained). 
